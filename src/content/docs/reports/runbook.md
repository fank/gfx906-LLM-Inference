...
| Prod model | Ornith-1.0-35B Q4_K_M + embedded MTP, container `llama-hipgraphs`, compose `/home/josh/llm/docker-compose-hipgraphs.yml`, **port 8089**, model id `ornith-hipgraphs` |
| Bench tool | **`uvx llama-benchy`** (eugr/llama-benchy 0.4.0) — OpenAI-API client, non-destructive |
| Models dir | `/home/josh/llm/models` (mounted as `/models` in containers) |
...
uvx --from huggingface_hub hf download <repo> <file.gguf> --local-dir /home/josh/llm/models/<dir>
```
...
docker run --rm --device /dev/kfd --device /dev/dri --group-add video --group-add render \
  --security-opt seccomp=unconfined -e ROCR_VISIBLE_DEVICES=0 -v /home/josh/llm/models:/models \
...
|---|---|
| Ornith / Qwen3.5-A3B | `/home/josh/llm/rocm-cache/huggingface/hub/models--Qwen--Qwen3.5-35B-A3B/snapshots/59d61f3ce65a6d9863b86d2e96597125219dc754` |
| Qwen3.6 (any) | `/home/josh/llm/rocm-cache/huggingface/hub/models--Qwen--Qwen3.6-35B-A3B/snapshots/995ad96eacd98c81ed38be0c5b274b04031597b0` |
| gemma-4-12b | `/home/josh/.cache/huggingface/hub/models--google--gemma-4-12B-it/snapshots/e18f459f54832f4ae2ab6686b935a2268668a9e9` |
...
cd /home/josh/llm && docker compose -f docker-compose-hipgraphs.yml up -d
# VERIFY:
...
```
Then: **delete the test GGUF** (`rm -rf /home/josh/llm/models/<dir>`), write the report to `~/Dokumente/LLM Tests/`, add its line to the master report + sweep chart, update memory.
...
- Prod compose: `/home/josh/llm/docker-compose-hipgraphs.yml` · models: `/home/josh/llm/models/`
